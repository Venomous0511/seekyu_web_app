...
<section class="flex justify-center items-center min-h-screen">
    <div id="loginFormContainer" class="max-w-lg w-full mx-auto bg-gray-800 p-8 rounded-lg shadow-lg">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-bold text-white" id="formTitle">Head SG, SG, Client Login</h2>
        ...
        <form action="{{ route('login.process') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="role_id" placeholder="Enter ID (e.g. hsg.001, sg.001, c.001)" class="w-full rounded-md p-2 bg-gray-700 text-white focus:ring-2 focus:ring-indigo-400 focus:outline-none">
            </div>
